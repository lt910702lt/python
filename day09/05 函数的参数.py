...
# yue("陌陌", 33)
# 参数: 在函数执行的时候给函数传递的信息
# 形参: 在函数声明的位置,声明出拉变量: yue(fangshi)
# 实参: 在函数调用的时候,实际给函数传递的值: yue("探探")
...
#       1. 位置参数
#       2. 默认值参数
#       3. 默认值参数和和位置参数混合使用. 顺序: 先写位置参数. 然后在写默认值参数


# def gn(name, age, address, id, sex, hobby):
#     print("人的名字交%s,年龄:%s,地址:%s,id:%s,性别:%s,爱好%s" % (name, age, address, id, sex, hobby))
#
#
# gn("太白", "58", "保定", 1, "不详", "女")
